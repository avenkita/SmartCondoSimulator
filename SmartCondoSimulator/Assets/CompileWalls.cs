...
public class CompileWalls : MonoBehaviour
{
            ...
            foreach (XmlNode transformItems in transformcontent)
            {
                ...
                foreach (XmlNode transformItems2 in transformcontent2)
                {
                    ...
                    foreach (XmlNode transformItems3 in transformcontent3)
                    {
                        ...
                        {
                            if (transformItems4.Name == "door") { wallsimulation = null; } //wall with door is set to null (because it will be instantiated in the doors codes)
