...
public class CompileDoors : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int doornumber = 0; doornumber < WallsList.Count; doornumber++)
        {
            ...
            writer.WriteStartElement("id"); writer.WriteRaw(dw.doorid); writer.WriteEndElement();
            ...
            //     go.transform.position = new Vector3(dw.PositionXd, 70, dw.PositionZd);
            //     go.transform.localScale = new Vector3(dw.ScaleXd, 140, dw.ScaleZd);
            //     go.name = dw.doorid;
        }
        writer.WriteEndElement();
